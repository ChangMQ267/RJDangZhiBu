...
<html>
  ...
  <table width="1000" border="1" cellpadding="0" cellspacing="0" align="center">
  		<tr height="40">
  			...
  			<td width="340" align="center">专业名称</td>
  			<td width="330" align="center" colspan="3">操作</td>
  		</tr>
 		...
 		<tr>
 			<td colspan="5" align="right">
 				<a href="admin/Professional-list?currentPage=1">首页</a>
  				<a href="admin/Professional-list?currentPage=${pm.getPreviousPage() }">上一页</a>
  				...
  				<a href="admin/Professional-list?currentPage=${pm.getNextPage() }">下一页</a>
  				<a href="admin/Professional-list?currentPage=${pm.getLastPage() }">尾页</a>
  				总页数：${pm.getTotalPage() }
 			</td>
 		</tr>
 		<tr>
 			<td colspan="5" align="center">共有专业<font color="red">${pm.totalRecords }</font>个</td>
 		</tr>
  	</table>
  </body>
</html>
