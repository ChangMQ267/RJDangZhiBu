...
<c:when test="${session.login.state == 2 }">
  <form name="form" action="admin/UserInfo-add" method="post" onSubmit="return check()">
  	<table align="center" width="800">
  		<tr>
  			<td width="300" align="right">用户账号:</td>
  			<td width="300">
  				<input id="username" type="text" name="userInfo.username" onblur="checkUsername(this.value)"/>
  			</td>
  			<td width="200"><span id="usernameError"></span></td>
  		<tr>
  		...
  		<tr>
  			...
  			<td>
  				<input id="password2" type="password" name="pwd" onblur="checkPassword2(this.value)" />
  			</td>
  		...
  		<tr>
  			...
  			<td>
  				<input id="studentName" type="text" name="userInfo.studentName" onblur="checkStudentName(this.value)" />
  			</td>
  		...
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.applyParty" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.departGradu" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.activist" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.ready" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.positive" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.relationIn" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input class="Wdate" readonly="readonly" name="userInfo.relationOut" type="text" onClick="WdatePicker()">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
  			...
  			<td>
  				<input name="userInfo.flow" type="text">
  			</td>
  			<td></td>
  		</tr>
  		<tr>
